...
Entre:
Le  bailleur M. <b>Momar  DIAGNE</b>, <b>PC n° 327812 du 09 Juin 1999</b> et Le preneur, <b><?php echo $_GET['nom'] ?></b>, <b>CI N° <?php echo $_GET['id'] ?></b>, délivrée  le  <b><?php echo $_GET['delivre'] ?></b> qui s’engage  à prendre en location les locaux dont la désignation suit : Villa n° 180, Cité HILAL,
 <b><?php echo $_GET['local'] ?></b>, sans qu’il soit nécessaire de désigner les lieux plus amplement, les connaissant pour les avoir visités. <br>
Cette location qui prendra effet le <b>1er janvier 2017</b> est usage d’habitation.
Elle est consentie au prix de <b><?php echo  $_GET['prix'] ?> francs CFA</b> payable par terme mensuel et d’avance au plus tard le 05 de chaque mois.<br><br>
A cela  il faut ajouter 

<?php if ($_GET['local']=="ComicoA" || $_GET['local']=="ComicoB") 
	echo "la taxe d’enregistrement sur location de <b>".$_GET['contrat']."</b> francs  à verser à   la signature du présent contrat";
...
<ul>
	...
	<li>la taxe d’enregistrement sur location de <b>".$_GET['contrat']."</b> francs  à verser à   la signature du présent contrat</li>
</ul>";
...
<p class="text-justify">
<b><u>CAUTION :</u></b> <br>
Le preneur verse  à titre de caution  la somme de  <b><?php echo $_GET['prix']*2 ?> F CFA</b> 
...
<p class="pull-right">Fait à Dakar, le 01 janvier 2017 </p><br>
